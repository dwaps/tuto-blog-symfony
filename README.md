...
## 1. Récupération du code des modules
  ...
  a. Choisissez un emplacement sur votre ordinateur et saisissez la commande suivante dans un terminal :
    ...
    git clone https://github.com/dwaps/tuto-blog-symfony

OU BIEN,

  b. Télécharger l'archive zip [https://github.com/dwaps/tuto-blog-symfony/archive/master.zip](https://github.com/dwaps/tuto-blog-symfony/archive/master.zip). Il vous suffira ensuite de la décompresser ou vous voulez pour travailler.
